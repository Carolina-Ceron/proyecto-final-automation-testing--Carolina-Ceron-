...
### Logs de ejecucion
Tambien se genera un log con informacion detallada de toda la ejecucion de las pruebas en la siguiente ubicacion: ```logs/suite.log```
...
- Comportamiento de la pagina de inventario Comportamiento de la pagina del carrito
